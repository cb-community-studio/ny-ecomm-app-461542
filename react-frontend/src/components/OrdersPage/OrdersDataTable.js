...
const OrdersDataTable = ({ items, onEditRow, onRowDelete, onRowClick }) => {
    ...
    const pTemplate4 = (rowData, { rowIndex }) => <p >{rowData.totalprice}</p>
    ...
    return (
        <DataTable value={items} onRowClick={onRowClick} scrollable rowHover paginator rows={10}>
            <Column field="orderid" header="Order Number"  style={{ minWidth: "8rem" }} />
            ...
            <Column field="totalprice" header="Subtotal" body={pTemplate4} style={{ minWidth: "8rem" }} />
