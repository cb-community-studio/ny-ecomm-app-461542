        ...
        <Dialog header="Create" visible={props.show} closable={false} onHide={props.onHide} modal style={{ width: "40vw" }} className="min-w-max" footer={renderFooter()} resizable={false}>
            <div role="orders-create-dialog-component">
                <div>
                    ...
                    <InputText type="number" className="w-full mb-3" value={_entity?.orderid} onChange={(e) => setValByKey("orderid", e.target.value)}  />
                </div>
                <div>
                ...
                <div>
                    ...
                    <InputText type="number" className="w-full mb-3" value={_entity?.totalprice} onChange={(e) => setValByKey("totalprice", e.target.value)}  />
                </div>
